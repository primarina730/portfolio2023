    ...
    <div>
      ...
      <div className="photo_introductions">
        ...
        <div className="myintroductions">
          ...
          <p>
            非常に犬が好きです。将来はバセットハウンドか、セントバーナード、もしくは、バーニーズマウンテンドッグと一生に暮らすことが夢です。成果物のブログはやや黒歴史になりつつありますが、成果物なので置いておきます。フリーレンのコスプレに挑戦してみたいですが、誰も長身のフリーレンに需要を感じていない、解釈違いだと思うので、一生挑戦できないと思います。
          </p>
        </div>
      </div>
